...
export function Aplicativo(){
    return(
        <div className="bg-[url('./src/assets/bgClaro.png')] dark:bg-[url('./src/assets/bgEscuro.png')] bg-cover h-screen w-screen">
            <HeaderLogadoClaro/>
            <div className="flex justify-center align-center gap-50">
                <div className="flex flex-col pt-10 font-questrial text-white">
                    <h1 className="text-8xl pb-10 text-shadow-sm text-shadow-cyan-shadow-como">Baixe o app</h1>
